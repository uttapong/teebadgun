	...
	$("#addgym").submit(function(e)
	{
	    ...
	    $.ajax(
	    {
	        ...
	        success:function(data, textStatus, jqXHR) 
	        {
	        	...
	        	console.log(data);
	            if(data==1)bootbox.alert("คุณได้เพิ่มข้อมูลสนามใหม่เรียบร้อยแล้ว",function() {
...
<div class="row">
  	<div class="col-md-12 left">
                <h1 class="title">เพิ่มคอร์ทแบดมินตัน</h1>
	</div>
...
<span class="glyphicon glyphicon-info-sign"></span> คลิกบนแผนที่เพื่อระบุพิกัดของคอร์ทแบดมินตัน</div>
  ...
  <div class="col-md-7 left">
	...
	<div class="row">
        ...
        <div class="col-md-12 left">
            <div id="open-team">
                         {{ Form::open(array('url' => 'gym/add','method'=>'post','id'=>'addgym','role'=>'form','class'=>'form-horizontal')) }}
						  ...
						  <div class="form-group">
						    ...
						    <div class="col-sm-4">
						      <input type="text" class="form-control" name="lat" id="lat" onkeyup="$(this).val('')">
						    </div>
						    <label for="inputPassword3" class="col-sm-2 control-label">ลองติจูด</label>
						    <div class="col-sm-4">
						      <input type="text" class="form-control" name="long" id="long" onkeyup="$(this).val('')">
						    </div>
						  ...
						  <div class="form-group">
						    ...
						    <div class="col-sm-4">
						      <input type="text" class="form-control" name="court_count">
						    </div>
						  </div>
						  <div class="form-group">
						  ...
						  <div class="form-group">
						    ...
						    <div class="col-sm-12" style='margin-left: 8px;'>
						     ...
						     <input type="checkbox" name='openday[]' value='จันทร์' checked> จันทร์
						     <input type="checkbox" name='openday[]' value='อังคาร' checked> อังคาร
						     <input type="checkbox" name='openday[]' value='พุธ' checked> พุธ
						     <input type="checkbox" name='openday[]' value='พฤหัส' checked> พฤหัสบดี
						     <input type="checkbox" name='openday[]' value='ศุกร์' checked> ศุกร์
						     <input type="checkbox" name='openday[]' value='เสาร์' checked> เสาร์
						     <input type="checkbox" name='openday[]' value='อาทิตย์' checked> อาทิตย์
						  ...
						  <div class="form-group">
						    ...
						    <div class="col-sm-4 input-group ">
						    	<div class="bfh-timepicker" data-time="08:00" data-name="open_time"></div>
								
						    </div>
						    <label for="inputPassword3" class="col-sm-2 control-label">เวลาปิด</label>
						    <div class="col-sm-4  input-group ">
						      	<div class="bfh-timepicker" data-time="24:00" data-name="close_time"></div>
						    </div>
						  </div>
						  <div class="form-group">
