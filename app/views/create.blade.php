...
@section('title')
Teebadgun.com : สร้างทีม หรือ คอร์ทแบดมินตัน
@stop
@section('script')
<script>
</script>
  ...
  <div class="col-md-12 profile-header">
    ...
    <div class='row'>
        <div class="col-md-3 left">
          <h1>ชื่อทีม: {{ $team->name }}</h1>
          @if($team->logo)
          <img src="{{ $team->logo }}" class="profile-image" />
          @else
          <img src="{{ asset('assets/images/guest.jpg'); }}" class="profile-image" />
          @endif
...
<div class="row">
  ...
  @foreach($team->members as $member)
    ...
    <div class='profile-team-icon'><a href='{{route('profile',array($member->user()->username))}}'>
